...
class CustomSpinnerCrewNicknameAdapter(context: Context, @LayoutRes private val resId: Int, private val menuList: List<MessageModel.MessageSpinnerCrewNicknameItem>, private val messageViewModel: MessageViewModel)
    : ArrayAdapter<MessageModel.MessageSpinnerCrewNicknameItem>(context, resId, menuList) {

    private var _menuList = arrayListOf<MessageModel.MessageSpinnerCrewNicknameItem>()
    ...
    override fun getView(position: Int, converView: View?, parent: ViewGroup): View {
        ...
        binding.messageTypeTv.text = menuList[position].nickname
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        menuList.forEachIndexed { index, messageSpinnerCrewNicknameItem ->
    ...
    fun setMenuList(list: ArrayList<MessageModel.MessageSpinnerCrewNicknameItem>) {
        _menuList = list
